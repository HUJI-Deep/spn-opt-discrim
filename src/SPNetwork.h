...
namespace SPN {
    ...
    public:
        ...
        double Eval(const std::vector<double> &input, const std::vector<bool> &mask);
        std::vector<int> batchClassify(const std::vector<std::vector<double>> &inputs, bool verbose);
        std::vector<int> batchClassify(const std::vector<std::vector<double>> &inputs,const std::vector<std::vector<bool>> &masks, bool verbose);
        int Classify(const std::vector<double> &input, const std::vector<bool> &mask);
